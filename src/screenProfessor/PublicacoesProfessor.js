  ...
  const Usuario = ({ nome, cargo, theme }) => {
    ...
    return (
      <View style={styles.informacoesPublicacao}>
        ...
        <Text
          style={[
            theme === 'escuro' ? styles.darkText : styles.lightText, { fontSize } // Aplica o tamanho de fonte dinâmico no cargo também
          ]}
        >
          {cargo}
        </Text>
